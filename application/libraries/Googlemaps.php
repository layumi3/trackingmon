...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAM0v0x8KwILS1QA7mXfo8TJheGq9fDjrs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_type					= "TERRAIN";				// The default MapType. Values accepted are 'HYBRID', 'ROADMAP', 'SATELLITE' or 'TERRAIN'
